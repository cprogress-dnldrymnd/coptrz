			...
			$this->module_fields(
				array(
					...
					Field::make('multiselect', 'featured_posts', 'Template')
						->set_options($PostMeta->get_posts('templates', 'Featured Posts')),
...
Container::make('theme_options', __('Settings'))
	...
	->add_fields(
		array(
			Field::make('association', 'suggested_articles', 'Suggested Articles')
				->set_types(
					array(
						array(
							'type'      => 'post',
			...
			Field::make('association', 'featured_posts', 'Featured Posts')
				->set_types(
					array(
						array(
							'type'      => 'post',
